...
angular.module("pascalprecht.translate").directive("translate", [ "$translate", "$q", "$interpolate", "$compile", "$parse", "$rootScope", function(a, b, c, d, e, f) {
    ...
    function _t(n, t, e) {
        ...
        r *= 60) : (r = 0/0, u = c > 0 && 1 > c ? 0 : r), new at(r, u, c);
    }
    function wt(n, t, e) {
    ...
    function Nt(n, t, e, r) {
        ...
        "onload" in c ? c.onload = c.onerror = u : c.onreadystatechange = function() {
            ...
            null == t || "accept" in a || (a.accept = t + ",*/*"), c.setRequestHeader) for (var s in a) c.setRequestHeader(s, a[s]);
            return null != t && c.overrideMimeType && c.overrideMimeType(t), null != l && (c.responseType = l), 
    ...
    function qt() {
        var n = Lt(), t = Tt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(tc), tc = setTimeout(qt, t)), nc = 0) : (nc = 1, 
        rc(qt));
    }
    function Lt() {
        var n = Date.now();
    ...
    function Tt() {
        for (var n, t = Ka, e = 1 / 0; t; ) t.f ? t = n ? n.n = t.n : Ka = t.n : (t.t < e && (e = t.t), 
        t = (n = t).n);
        return Qa = n, e;
    }
    function Rt(n, t) {
    ...
    function Pt(n) {
        ...
        return function(n) {
            ...
            switch (h && (h = +h.substring(1)), (l || "0" === r && "=" === o) && (l = r = "0", 
            o = "="), g) {
              case "n":
                f = !0, g = "g";
                break;
            ...
            return function(n) {
                ...
                return M && (x = i(k + x, k.length ? s - b.length : 1 / 0)), u += v, n = x + b, 
    ...
    function Ft(n, t, e) {
        ...
        var c = n.utc = Ht(n);
        return c.floor = c, c.round = Ht(r), c.ceil = Ht(u), c.offset = Ht(i), c.range = a, 
        n;
    }
    function Ht(n) {
        return function(t, e) {
    ...
    function Ot(n) {
        function t(n) {
            function t(t) {
                for (var e, u, i, o = [], a = -1, c = 0; ++a < r; ) 37 === n.charCodeAt(a) && (o.push(n.slice(c, a)), 
                null != (u = sc[e = n.charAt(++a)]) && (e = n.charAt(++a)), (i = N[e]) && (e = i(t, null == u ? "e" === e ? " " : "0" : u)), 
                o.push(e), c = a + 1);
            ...
            return t.parse = function(t) {
                ...
                o.setHours(r.H + (r.Z / 100 | 0), r.M + r.Z % 100, r.S, r.L), i ? o._ : o;
            }, t.toString = function() {
                return n;
            }, t;
        }
    ...
    function Se() {
        function n(n, u) {
            ...
            bc += l, kc += l * (t + (t = o)), Ec += l * (e + (e = a)), Ac += l * (r + (r = c)), 
            we(t, e, r);
        }
        var t, e, r;
    ...
    function Ee() {
        function n(n, t) {
            ...
            Nc += p * l, Cc += p * s, zc += p * f, bc += v, kc += v * (r + (r = o)), Ec += v * (u + (u = a)), 
            Ac += v * (i + (i = c)), we(r, u, i);
        }
        var t, e, r, u, i;
    ...
    function Ce(n, t, e, r, u) {
        ...
        if (n.forEach(function(n) {
            if (!((t = n.length - 1) <= 0)) {
                ...
                c.o = l, i.push(c), o.push(l), c = new qe(r, n, null, !1), l = new qe(r, null, c, !0), 
                c.o = l, i.push(c), o.push(l);
            }
        ...
        return function(u, i) {
            ...
            var g, p, v, d = t(i), m = u.invert(r[0], r[1]), y = {
                ...
                polygonEnd: function() {
                    ...
                    var n = Fe(m, p);
                    g.length ? (b || (i.polygonStart(), b = !0), Ce(g, De, n, e, i)) : n && (b || (i.polygonStart(), 
                    b = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()), b && (i.polygonEnd(), 
                    b = !1), g = p = null;
                },
                sphere: function() {
    ...
    function Pe(n) {
        ...
        return {
            ...
            point: function(i, o) {
                ...
                ga(c - qa) < Ca ? (n.point(e, r = (r + o) / 2 > 0 ? Ra : -Ra), n.point(u, r), n.lineEnd(), 
                n.lineStart(), n.point(a, r), n.point(i, r), t = 0) : u !== a && c >= qa && (ga(e - u) < Ca && (e -= u * Ca), 
                ga(i - a) < Ca && (i -= a * Ca), r = Ue(e, r, i, o), n.point(u, r), n.lineEnd(), 
    ...
    function je(n, t, e, r) {
        var u;
        if (null == n) u = e * Ra, r.point(-qa, u), r.point(0, u), r.point(qa, u), r.point(qa, 0), 
        r.point(qa, -u), r.point(0, -u), r.point(-qa, -u), r.point(-qa, 0), r.point(-qa, u); else if (ga(n[0] - t[0]) > Ca) {
            var i = n[0] < t[0] ? qa : -qa;
    ...
    function Fe(n, t) {
        ...
        for (var a = 0, c = t.length; c > a; ++a) {
            ...
            if (s) for (var f = l[0], h = f[0], g = f[1] / 2 + qa / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ;) {
                ...
                if (yc.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))), i += S ? b + _ * La : b, 
                S ^ h >= e ^ m >= e) {
                    var E = de(pe(f), pe(n));
                    Me(E);
                    var A = de(u, E);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!e && (l = c = v) && n.lineStart(), v !== c && (g = r(e, p), (be(e, g) || be(p, g)) && (p[0] += Ca, 
                    p[1] += Ca, v = t(p[0], p[1]))), v !== c) s = 0, v ? (n.lineStart(), g = r(p, e), 
                    n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g; else if (a && e && o ^ v) {
                        var m;
                        d & i || !(m = r(p, e, !0)) || (s = 0, o ? (n.lineStart(), n.point(m[0][0], m[0][1]), 
    ...
    function Ie(n, t, e, r) {
        ...
        return function(a) {
            function c(n) {
                for (var t = 0, e = d.length, r = n[1], u = 0; e > u; ++u) for (var i, o = 1, a = d[u], c = a.length, l = a[0]; c > o; ++o) i = a[o], 
            ...
            function p(n, t) {
                ...
                var e = s(n, t);
                if (d && m.push([ n, t ]), S) y = n, M = t, x = e, S = !1, e && (a.lineStart(), 
                a.point(n, t)); else if (e && w) a.point(n, t); else {
                    ...
                    N(r) ? (w || (a.lineStart(), a.point(r.a.x, r.a.y)), a.point(r.b.x, r.b.y), e || a.lineEnd(), 
            ...
            var v, d, m, y, M, x, b, _, w, S, k, E = a, A = Re(), N = Oe(n, t, e, r), C = {
                ...
                polygonEnd: function() {
                    ...
                    u && Ce(v, i, t, l, a), a.polygonEnd()), v = d = m = null;
                }
            };
            return C;
        };
    ...
    function Ke() {
        function n(n, t) {
            ...
            kc += o * (r + n) / 2, Ec += o * (u + t) / 2, Ac += o, o = u * n - r * t, Nc += o * (r + n), 
            Cc += o * (u + t), zc += 3 * o, We(r = n, u = t);
        }
        var t, e, r, u;
    ...
    function nr(n) {
        ...
        function u(t, e, r, a, c, l, s, f, h, g, p, v, d, m) {
            ...
            if (x > 4 * i && d--) {
                ...
                m.point(N, C), u(N, C, E, b, _, w, s, f, h, g, p, v, d, m));
            }
        }
    ...
    function ir(n) {
        ...
        return t.stream = function(n) {
            ...
            return arguments.length ? (S = n, _ = n ? Ie(n[0][0], n[0][1], n[1][0], n[1][1]) : y, 
            u()) : S;
        }, t.scale = function(n) {
            ...
            return arguments.length ? (m = n[0] % 360 * Da, M = n[1] % 360 * Da, x = n.length > 2 ? n[2] % 360 * Da : 0, 
            r()) : [ m * Pa, M * Pa, x * Pa ];
    ...
    function gr(n, t) {
        ...
        return function(u, i, o, a) {
            var c = o * t;
            null != u ? (u = pr(e, u), i = pr(e, i), (o > 0 ? i > u : u > i) && (u += o * La)) : (u = n + o * La, 
            i = n - .5 * c);
    ...
    function jr(n) {
        ...
        if (Qc.insert(t, c), t || e) {
            if (t === e) return Xr(t), e = Dr(t.site), Qc.insert(c, e), c.edge = e.edge = Jr(t.site, c.site), 
            Vr(t), void Vr(e);
            ...
            Kr(e.edge, l, p, x), c.edge = Jr(l, n, null, x), e.edge = Jr(n, p, null, x), Vr(t), 
            Vr(e);
        }
    }
    function Fr(n, t) {
    ...
    function Ir(n) {
        for (var t, e, r, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = Kc, d = v.length; d--; ) if (i = v[d], 
        i && i.prepare()) for (a = i.edges, c = a.length, o = 0; c > o; ) s = a[o].end(), 
        r = s.x, u = s.y, l = a[++o % c].start(), t = l.x, e = l.y, (ga(r - t) > Ca || ga(u - e) > Ca) && (a.splice(o, 0, new Qr(Gr(i.site, s, ga(r - f) < Ca && p - u > Ca ? {
            x: f,
            y: ga(t - f) < Ca ? e : p
        } : ga(u - p) < Ca && h - r > Ca ? {
            x: ga(e - p) < Ca ? t : h,
    ...
    function $r(n) {
        for (var t, e = Gc, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--; ) t = e[u], 
    ...
    function Jr(n, t, e, r) {
        var u = new Wr(n, t);
        return Gc.push(u), e && Kr(u, n, t, e), r && Kr(u, t, n, r), Kc[n.i].edges.push(new Qr(u, n, t)), 
        Kc[t.i].edges.push(new Qr(u, t, n)), u;
    }
    function Gr(n, t, e) {
        var r = new Wr(n, null);
    ...
    function iu(n, t) {
        ...
        for (Gc = [], Kc = new Array(n.length), Qc = new nu(), tl = new nu(); ;) if (u = nl, 
        i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== e || i.y !== r) && (Kc[i.i] = new Or(i), 
        jr(i), e = i.x, r = i.y), i = n.pop(); else {
            if (!u) break;
            Ur(u.arc);
        }
        t && ($r(t), Ir(t));
    ...
    function fu(n, t, e, r, u, i) {
        if (!n(t, e, r, u, i)) {
            ...
            c[0] && fu(n, c[0], e, r, o, a), c[1] && fu(n, c[1], o, r, u, a), c[2] && fu(n, c[2], e, a, o, i), 
    ...
    function du(n, t) {
        ...
        for (n += "", t += ""; (e = il.exec(n)) && (r = ol.exec(t)); ) (u = r.index) > i && (u = t.slice(i, u), 
        a[o] ? a[o] += u : a[++o] = u), (e = e[0]) === (r = r[0]) ? a[o] ? a[o] += r : a[++o] = r : (a[++o] = null, 
        c.push({
            i: o,
            x: vu(e, r)
        })), i = ol.lastIndex;
        return i < t.length && (u = t.slice(i), a[o] ? a[o] += u : a[++o] = u), a.length < 2 ? c[0] ? (t = c[0].x, 
        function(n) {
            return t(n) + "";
        }) : function() {
            return t;
    ...
    function Cu(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / La * Math.asin(1 / n) : (n = 1, 
        e = t / 4), function(r) {
    ...
    function Pu(n) {
        ...
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, u *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Pa, 
        this.translate = [ n.e, n.f ], this.scale = [ r, i ], this.skew = i ? Math.atan2(u, i) * Pa : 0;
    }
    function Uu(n, t) {
        return n[0] * t[0] + n[1] * t[1];
    }
    ...
    function Hu(n, t) {
        ...
        u.push({
            ...
            i: 3,
            x: vu(a[1], c[1])
        })) : r.push(c[0] || c[1] ? "translate(" + c + ")" : ""), l != s ? (l - s > 180 ? s += 360 : s - l > 180 && (l += 360), 
        u.push({
    ...
    function Yu(n) {
        for (var t = n.source, e = n.target, r = Vu(t, e), u = [ t ]; t !== r; ) t = t.parent, 
        u.push(t);
    ...
    function Gu(n, t) {
        return ta.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links = ri, 
        n;
    }
    function Ku(n, t) {
    ...
    function Mi(n) {
        function t(n) {
            s = Math.min(n.x - n.r, s), f = Math.max(n.x + n.r, f), h = Math.min(n.y - n.r, h), 
            g = Math.max(n.y + n.r, g);
        }
        if ((e = n.children) && (l = e.length)) {
            var e, r, u, i, o, a, c, l, s = 1 / 0, f = -1 / 0, h = 1 / 0, g = -1 / 0;
            if (e.forEach(xi), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (u = e[1], u.x = u.r, 
            u.y = 0, t(u), l > 2)) for (i = e[2], wi(r, u, i), t(i), di(r, i), r._pack_prev = i, 
            di(i, u), u = r._pack_next, o = 3; l > o; o++) {
                wi(r, u, i = e[o]);
                var p = 0, v = 1, d = 1;
                ...
                if (1 == p) for (c = r._pack_prev; c !== a._pack_prev && !yi(c, i); c = c._pack_prev, 
                d++) ;
                p ? (d > v || v == d && u.r < r.r ? mi(r, u = a) : mi(r = c, u), o--) : (di(r, i), 
                u = i, t(i));
            }
    ...
    function Qi(n, t) {
        ...
        return e.domain = function(r) {
            ...
            return i = r(s + Math.round((f - s - (n.length - a) * h) / 2), h), l && i.reverse(), 
    ...
    function ho(n) {
        function t(t) {
            ...
            for (var c, l = [], s = [], f = -1, h = t.length, g = Et(e), p = Et(r); ++f < h; ) u.call(this, c = t[f], f) ? s.push([ +g.call(this, c, f), +p.call(this, c, f) ]) : s.length && (o(), 
            s = []);
    ...
    function ko(n) {
        ...
        for (e.push(No(Cl, i) + "," + No(Cl, o)), --r; ++r < u; ) t = n[r], i.shift(), i.push(t[0]), 
        o.shift(), o.push(t[1]), Co(e, i, o);
        return e.join("");
    }
    function Eo(n) {
        for (var t, e, r = -1, u = n.length, i = u + 4, o = [], a = []; ++r < 4; ) e = n[r % u], 
        o.push(e[0]), a.push(e[1]);
        for (t = [ No(Cl, o), ",", No(Cl, a) ], --r; ++r < i; ) e = n[r % u], o.shift(), 
        o.push(e[0]), a.shift(), a.push(e[1]), Co(t, o, a);
        return t.join("");
    }
    function Ao(n, t) {
        var e = n.length - 1;
        if (e) for (var r, u, i = n[0][0], o = n[0][1], a = n[e][0] - i, c = n[e][1] - o, l = -1; ++l <= e; ) r = n[l], 
        u = l / e, r[0] = t * r[0] + (1 - t) * (i + u * a), r[1] = t * r[1] + (1 - t) * (o + u * c);
        return So(n);
    }
    function No(n, t) {
    ...
    function Lo(n) {
        ...
        ga(t) < Ca ? o[a] = o[a + 1] = 0 : (e = o[a] / t, r = o[a + 1] / t, u = e * e + r * r, 
    ...
    function Ro(n) {
        for (var t, e, r, u = -1, i = n.length; ++u < i; ) t = n[u], e = t[0], r = t[1] - Ra, 
    ...
    function Do(n) {
        function t(t) {
            ...
            for (var h, g, p, v = [], d = [], m = [], y = -1, M = t.length, x = Et(e), b = Et(u), _ = e === r ? function() {
                ...
                return p;
            } : Et(i); ++y < M; ) o.call(this, h = t[y], y) ? (d.push([ g = +x.call(this, h, y), p = +b.call(this, h, y) ]), 
        ...
        return t.x = function(n) {
            ...
            l = a.reverse || a, s = a.closed ? "M" : "L", t) : c;
        }, t.tension = function(n) {
    ...
    function Io(n) {
        return function() {
            ...
            t.active += .5, e.event && e.event.interrupt.call(this, this.__data__, e.index));
        };
    }
    function Yo(n, t, e) {
        ...
        if (!o) {
            ...
            o = i[r] = {
                ...
                function c(e) {
                    ...
                    i.active = r, o.event && o.event.start.call(n, n.__data__, t), o.tween.forEach(function(e, r) {
    ...
    ta.ascending = e, ta.descending = function(n, t) {
        ...
        if (1 === arguments.length) for (;++l < o; ) u(e = r(n[l])) && (i = e - a, a += i / ++s, 
        c += i * (e - a)); else for (;++l < o; ) u(e = r(t.call(n, n[l], l))) && (i = e - a, 
        a += i / ++s, c += i * (e - a));
    ...
    ta.bisectLeft = ha.left, ta.bisect = ta.bisectRight = ha.right, ta.bisector = function(n) {
        ...
        for (var r, u, i = e - t; i; ) u = Math.random() * i-- | 0, r = n[i + t], n[i + t] = n[u + t], 
        n[u + t] = r;
        return n;
    ...
    _a.select = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            for (var c = -1, l = r.length; ++c < l; ) (u = r[c]) ? (t.push(e = n.call(u, u.__data__, c, o)), 
        ...
        var t, e, r = [];
        n = C(n);
        for (var u = -1, i = this.length; ++u < i; ) for (var o = this[u], a = -1, c = o.length; ++a < c; ) (e = o[a]) && (r.push(t = ra(n.call(e, e.__data__, a, u))), 
        t.parentNode = e);
        return A(r);
    };
    var wa = {
    ...
    ta.ns = {
        ...
        function e(n, e) {
            ...
            if (t) {
                ...
                y[r] = d;
                for (r = -1; ++r < f; ) (u = m.get(d = t.call(e, i = e[r], r))) ? u !== !0 && (g[r] = u, 
                u.__data__ = i) : p[r] = H(i), m.set(d, !0);
            ...
            p.update = g, p.parentNode = g.parentNode = v.parentNode = n.parentNode, a.push(p), 
            c.push(g), s.push(v);
        }
    ...
    var Sa = [];
    ta.selection.enter = Z, ta.selection.enter.prototype = Sa, Sa.append = _a.append, 
    Sa.empty = _a.empty, Sa.node = _a.node, Sa.call = _a.call, Sa.size = _a.size, Sa.select = function(n) {
        for (var t, e, r, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
            r = (u = this[a]).update, o.push(t = []), t.parentNode = u.parentNode;
            for (var l = -1, s = u.length; ++l < s; ) (i = u[l]) ? (t.push(r[l] = e = n.call(u.parentNode, i.__data__, l, a)), 
        ...
        var e;
        return "string" == typeof t ? (e = [ Ma(t, ua) ], e.parentNode = ua.documentElement) : (e = [ t ], 
        e.parentNode = n(t)), A([ e ]);
    }, ta.selectAll = function(n) {
        var t;
        return "string" == typeof n ? (t = ra(xa(n, ua)), t.parentNode = ua.documentElement) : (t = n, 
        t.parentNode = null), A([ t ]);
    ...
    ta.interpolateZoom = function(n, t) {
        ...
        function o(t, e, r, o) {
            t.__chart__ = {
                ...
                y: k.y,
                k: k.k
            }, u(Math.pow(2, o)), i(d = e, r), t = ta.select(t), C > 0 && (t = t.transition().duration(C)), 
            t.call(n.event);
        }
        function a() {
        ...
        return e.parse = function(n, t) {
            ...
            function e() {
                ...
                for (;l > s; ) {
                    ...
                    if (10 === r) u = !0; else if (13 === r) u = !0, 10 === n.charCodeAt(s) && (++s, 
    ...
    var uc = [ "y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ].map(Dt);
    ta.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = ta.round(n, Rt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), 
        e = Math.max(-24, Math.min(24, 3 * Math.floor((e - 1) / 3)))), uc[8 + e / 3];
    };
    ...
    }), ac.week = ac.sunday, ac.weeks = ac.sunday.range, ac.weeks.utc = ac.sunday.utc.range, 
    ...
    ta.geo.bounds = function() {
        ...
        var s, f, h, g, p, v, d, m, y, M, x, b = {
            ...
            polygonEnd: function() {
                Mc.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > yc ? (s = -(h = 180), 
                f = -(g = 90)) : y > Ca ? g = 90 : -Ca > y && (f = -90), x[0] = s, x[1] = h;
            }
        };
        return function(n) {
            ...
            if (t) {
                M.sort(c);
                for (var e, r = 1, u = M[0], i = [ u ]; t > r; ++r) e = M[r], l(e[0], u) || l(e[1], u) ? (a(u[0], e[1]) > a(u[0], u[1]) && (u[1] = e[1]), 
        ...
        return za > u && (t = kc, e = Ec, r = Ac, Ca > bc && (t = _c, e = wc, r = Sc), u = t * t + e * e + r * r, 
    ...
    ta.geo.path = function() {
        function n(n) {
            ...
            o && o.valid || (o = u(i)), ta.geo.stream(n, o)), i.result();
        }
        function t() {
            return o = null, n;
        }
        ...
        return n.area = function(n) {
            ...
            return _c = wc = Sc = kc = Ec = Ac = Nc = Cc = zc = 0, ta.geo.stream(n, u(Ic)), 
            ...
            return arguments.length ? (i = null == (r = n) ? new $e() : new Qe(n), "function" != typeof a && i.pointRadius(a), 
            t()) : r;
        ...
        return n.lines = function() {
            ...
            return arguments.length ? (i = +t[0][0], u = +t[1][0], l = +t[0][1], c = +t[1][1], 
            i > u && (t = i, i = u, u = t), l > c && (t = l, l = c, c = t), n.precision(y)) : [ [ i, l ], [ u, c ] ];
            ...
            return arguments.length ? (y = +t, s = vr(a, o, 90), f = dr(r, e, y), h = vr(l, c, 90), 
            g = dr(i, u, y), n) : y;
    ...
    Or.prototype.prepare = function() {
        ...
        insert: function(n, t) {
            ...
            if (n) {
                ...
                e = n;
            } else this._ ? (n = uu(this._), t.P = null, t.N = n, n.P = n.L = t, e = n) : (t.P = t.N = null, 
            this._ = t, e = null);
            for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; ) r = e.U, e === r.L ? (u = r.R, 
            u && u.C ? (e.C = u.C = !1, r.C = !0, n = r) : (n === e.R && (eu(this, e), n = e, 
            e = n.U), e.C = !1, r.C = !0, ru(this, r))) : (u = r.L, u && u.C ? (e.C = u.C = !1, 
            r.C = !0, n = r) : (n === e.L && (ru(this, e), n = e, e = n.U), e.C = !1, r.C = !0, 
            eu(this, r))), e = n.U;
            this._.C = !1;
        },
        remove: function(n) {
            ...
            if (e = i ? o ? uu(o) : i : o, u ? u.L === n ? u.L = e : u.R = e : this._ = e, i && o ? (r = e.C, 
                ...
                do {
                    ...
                    if (n === u.L) {
                        if (t = u.R, t.C && (t.C = !1, u.C = !0, eu(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
                            t.R && t.R.C || (t.L.C = !1, t.C = !0, ru(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, 
                            eu(this, u), n = this._;
                            break;
                        }
                    } else if (t = u.L, t.C && (t.C = !1, u.C = !0, ru(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
                        t.L && t.L.C || (t.R.C = !1, t.C = !0, eu(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, 
                        ru(this, u), n = this._;
                        break;
                    }
                    t.C = !0, n = u, u = u.U;
        ...
        return n ? t(n) : (t.links = function(n) {
            ...
            return iu(e(n)).cells.forEach(function(e, r) {
                for (var u, i, o = e.site, a = e.edges.sort(Yr), c = -1, l = a.length, s = a[l - 1].edge, f = s.l === o ? s.r : s.l; ++c < l; ) u = s, 
                i = f, s = a[c].edge, f = s.l === o ? s.r : s.l, r < i.i && r < f.i && au(o, i, f) < 0 && t.push([ n[r], n[i.i], n[f.i] ]);
            }), t;
        }, t.x = function(n) {
    ...
    ta.geom.delaunay = function(n) {
        ...
        function i(n) {
            ...
            function l(n, t, e, r, u, o, a, c) {
                ...
                n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = su()), f ? u = l : a = l, h ? o = s : c = s, 
                i(n, t, e, r, u, o, a, c);
            }
            var s, f, h, g, p, v, d, m, y, M = Et(a), x = Et(c);
            if (null != t) v = t, d = e, m = r, y = u; else if (m = y = -(v = d = 1 / 0), f = [], 
            h = [], p = n.length, o) for (g = 0; p > g; ++g) s = n[g], s.x < v && (v = s.x), 
            s.y < d && (d = s.y), s.x > m && (m = s.x), s.y > y && (y = s.y), f.push(s.x), h.push(s.y); else for (g = 0; p > g; ++g) {
                var b = +M(s = n[g], g), _ = +x(s, g);
                v > b && (v = b), d > _ && (d = _), b > m && (m = b), _ > y && (y = _), f.push(b), 
                h.push(_);
            }
            var w = m - v, S = y - d;
            w > S ? y = d + w : m = v + S;
        ...
        var o, a = Ar, c = Nr;
        return (o = arguments.length) ? (a = cu, c = lu, 3 === o && (u = e, r = t, e = t = 0), 
        i(n)) : (i.x = function(n) {
    ...
    }, ta.interpolateRgb = gu, ta.interpolateObject = pu, ta.interpolateNumber = vu, 
    ...
    }, ta.interpolateHcl = Lu, ta.interpolateHsl = Tu, ta.interpolateLab = Ru, ta.interpolateRound = Du, 
    ...
    ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function() {
        ...
        return a.tick = function() {
            ...
            for (e = 0; _ > e; ++e) a = M[e], f = a.source, h = a.target, y = h.x - f.x, x = h.y - f.y, 
            (p = y * y + x * x) && (p = r * i[e] * ((p = Math.sqrt(p)) - u[e]) / p, y *= p, 
            x *= p, h.x -= y * (d = f.weight / (h.weight + f.weight)), h.y -= x * d, f.x += y * (d = 1 - d), 
            f.y += x * d);
            if ((d = r * v) && (y = l[0] / 2, x = l[1] / 2, e = -1, d)) for (;++e < b; ) a = m[e], 
            a.x += (y - a.x) * d, a.y += (x - a.y) * d;
            if (g) for (Ju(t = ta.geom.quadtree(m), r, o), e = -1; ++e < b; ) (a = m[e]).fixed || t.visit(n(a));
            for (e = -1; ++e < b; ) a = m[e], a.fixed ? (a.x = a.px, a.y = a.py) : (a.x -= (a.px - (a.px = a.x)) * s, 
            a.y -= (a.py - (a.py = a.y)) * s);
            c.tick({
                type: "tick",
                alpha: r
            ...
            for (t = 0; s > t; ++t) r = M[t], "number" == typeof r.source && (r.source = m[r.source]), 
    ...
    ta.layout.histogram = function() {
        function n(n, i) {
            ...
            if (g > 0) for (i = -1; ++i < h; ) a = l[i], a >= s[0] && a <= s[1] && (o = c[ta.bisect(f, a, 1, g) - 1], 
            o.y += p, o.push(n[i]));
            return c;
        }
        ...
        function u(n, t, e) {
            if (t) {
                ...
                u = ki(u), o && u; ) c = ki(c), i = Ei(i), i.a = n, r = o.z + f - u.z - l + a(o._, u._), 
                r > 0 && (Ai(Ci(o, n, e), n, r), l += r, s += r), f += o.m, l += u.m, h += c.m, 
                s += i.m;
        ...
        function n(n, i) {
            ...
            Qu(c, function(n) {
                var t = n.children;
                t && t.length ? (n.x = qi(t), n.y = zi(t)) : (n.x = o ? l += e(n, o) : 0, n.y = 0, 
                o = n);
            });
        ...
        function t(e) {
            ...
            if (i && i.length) {
                ...
                s.area += o.area, "squarify" !== g || (a = r(s, v)) <= p ? (h.pop(), p = a) : (s.area -= s.pop().area, 
                u(s, v, l, !1), v = Math.min(l.dx, l.dy), s.length = s.area = 0, p = 1 / 0);
        ...
        function u(n, t, e, r) {
            ...
            if (t == e.dx) {
                for ((r || s > e.dy) && (s = e.dy); ++i < o; ) u = n[i], u.x = a, u.y = l, u.dy = s, 
                a += u.dx = Math.min(e.x + e.dx - a, s ? c(u.area / s) : 0);
                u.z = !0, u.dx += e.x + e.dx - a, e.y += s, e.dy -= s;
            } else {
                for ((r || s > e.dx) && (s = e.dx); ++i < o; ) u = n[i], u.x = a, u.y = l, u.dx = s, 
        ...
        function i(r) {
            var u = o || a(r), i = u[0];
            return i.x = 0, i.y = 0, i.dx = l[0], i.dy = l[1], o && a.revalue(i), n([ i ], i.dx * i.dy / i.value), 
            (o ? e : t)(i), h && (o = u), u;
        }
    ...
    ta.scale.quantile = function() {
        ...
        function n() {
            ...
            g || (A *= -1), l && (A = tt(d / l * Math.sin(m))), n && (E = tt(d / n * Math.sin(m)))), 
            l) {
            ...
            } else N.push("M", y, ",", M), null != x && N.push("A", l, ",", l, " 0 ", C, ",", g, " ", x, ",", b), 
            N.push("L", _, ",", w), null != S && N.push("A", n, ",", n, " 0 ", q, ",", 1 - g, " ", S, ",", k);
    ...
    Pl.call = _a.call, Pl.empty = _a.empty, Pl.node = _a.node, Pl.size = _a.size, ta.transition = function(n, t) {
        ...
        for (var a = -1, c = this.length; ++a < c; ) {
            o.push(t = []);
            for (var l = this[a], s = -1, f = l.length; ++s < f; ) (r = l[s]) && (e = n.call(r, r.__data__, s, a)) ? ("__data__" in r && (e.__data__ = r.__data__), 
            $o(e, s, i, u, r[i][u]), t.push(e)) : t.push(null);
        }
        return Yo(o, i, u);
        ...
        for (var n, t, e, r, u = this.id, i = ++Ul, o = this.namespace, a = [], c = 0, l = this.length; l > c; c++) {
            a.push(n = []);
            for (var t = this[c], s = 0, f = t.length; f > s; s++) (e = t[s]) && (r = e[o][u], 
            $o(e, s, o, i, {
                time: r.time,
                ease: r.ease,
        ...
        function n(n) {
            n.each(function() {
                ...
                if ("bottom" === r || "top" === r ? (n = Bo, w = "x", k = "y", S = "x2", E = "y2", 
                C.attr("dy", 0 > L ? "0em" : ".71em").style("text-anchor", "middle"), _.attr("d", "M" + x[0] + "," + L * i + "V0H" + x[1] + "V" + L * i)) : (n = Wo, 
                w = "y", k = "x", S = "y2", E = "x2", C.attr("dy", ".32em").style("text-anchor", 0 > L ? "end" : "start"), 
                _.attr("d", "M" + L * i + "," + x[0] + "H0V" + x[1] + "H" + L * i)), A.attr(E, L * u), 
                z.attr(k, L * M), N.attr(S, 0).attr(E, L * u), q.attr(w, 0).attr(k, L * M), f.rangeBand) {
    ...
    ta.svg.brush = function() {
        function n(t) {
            t.each(function() {
                ...
                l && (c = Ui(l), h.attr("x", c[0]).attr("width", c[1] - c[0]), r(f)), s && (c = Ui(s), 
                h.attr("y", c[0]).attr("height", c[1] - c[0]), u(f)), e(f);
            });
        }
        function e(n) {
        ...
        function i() {
            ...
            function d() {
                ...
                x && (n[0] += x[0], n[1] += x[1]), C || (ta.event.altKey ? (M || (M = [ (f[0] + f[1]) / 2, (h[0] + h[1]) / 2 ]), 
                q[0] = f[+(n[0] < M[0])], q[1] = h[+(n[1] < M[1])]) : M = null), A && m(n, l, 0) && (r(k), 
                t = !0), N && m(n, s, 1) && (u(k), t = !0), t && (e(k), w({
                    type: "brush",
                    mode: C ? "move" : "resize"
                }));
            }
            function m(n, t, e) {
                ...
                return C && (c -= s, l -= d + s), r = (e ? p : g) ? Math.max(c, Math.min(l, n[e])) : n[e], 
                C ? u = (r += s) + d : (M && (s = Math.max(c, Math.min(l, 2 * M[e] - r))), r > s ? (u = r, 
                r = s) : u = s), v[0] != r || v[1] != u ? (e ? a = null : o = null, v[0] = r, v[1] = u, 
                !0) : void 0;
            }
            function y() {
                d(), k.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), 
                ta.select("body").style("cursor", null), L.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), 
                z(), w({
                    type: "brushend"
                });
            }
            ...
            k.interrupt().selectAll("*").interrupt(), C) q[0] = f[0] - q[0], q[1] = h[0] - q[1]; else if (E) {
                var T = +/w$/.test(E), R = +/^n/.test(E);
                x = [ f[1 - T] - q[0], h[1 - R] - q[1] ], q[0] = f[T], q[1] = h[R];
            } else ta.event.altKey && (M = q.slice());
            k.style("pointer-events", "none").selectAll(".resize").style("display", null), ta.select("body").style("cursor", _.style("cursor")), 
            w({
                type: "brushstart"
            }), d();
        }
        ...
        return n.event = function(n) {
            ...
            return arguments.length ? (l && s ? (g = !!t[0], p = !!t[1]) : l ? g = !!t : s && (p = !!t), 
            n) : l && s ? [ g, p ] : l ? g : s ? p : null;
        }, n.extent = function(t) {
            var e, r, u, i, c;
            return arguments.length ? (l && (e = t[0], r = t[1], s && (e = e[0], r = r[0]), 
            o = [ e, r ], l.invert && (e = l(e), r = l(r)), e > r && (c = e, e = r, r = c), 
            (e != f[0] || r != f[1]) && (f = [ e, r ])), s && (u = t[0], i = t[1], l && (u = u[1], 
            i = i[1]), a = [ u, i ], s.invert && (u = s(u), i = s(i)), u > i && (c = u, u = i, 
            i = c), (u != h[0] || i != h[1]) && (h = [ u, i ])), n) : (l && (o ? (e = o[0], 
            r = o[1]) : (e = f[0], r = f[1], l.invert && (e = l.invert(e), r = l.invert(r)), 
            e > r && (c = e, e = r, r = c))), s && (a ? (u = a[0], i = a[1]) : (u = h[0], i = h[1], 
            s.invert && (u = s.invert(u), i = s.invert(i)), u > i && (c = u, u = i, i = c))), 
